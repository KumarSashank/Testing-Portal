...
class AdminMasters extends StatefulWidget {
  const AdminMasters({Key? key}) : super(key: key);

  @override
  State<AdminMasters> createState() => _AdminMastersState();
}

class _AdminMastersState extends State<AdminMasters> {
  bool hover = true;
  @override
