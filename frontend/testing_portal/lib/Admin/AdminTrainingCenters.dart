...
class AdminTrainingCenters extends StatefulWidget {
  const AdminTrainingCenters({Key? key}) : super(key: key);

  @override
  State<AdminTrainingCenters> createState() => _AdminTrainingCentersState();
}

class _AdminTrainingCentersState extends State<AdminTrainingCenters> {
  bool hover = true;
  @override
