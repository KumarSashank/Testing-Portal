...
class SSCLoginScreen extends StatefulWidget {
  const SSCLoginScreen({Key? key}) : super(key: key);

  @override
  State<SSCLoginScreen> createState() => _SSCLoginScreenState();
}

class _SSCLoginScreenState extends State<SSCLoginScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    children: [
    SizedBox(width: 70.0,),
    Image(image: AssetImage('images/ssc.png'),  width: 509,
